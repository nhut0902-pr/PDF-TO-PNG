    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800 py-12 transition-colors">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-4">
          <div className="flex justify-center space-x-6 text-gray-400 dark:text-gray-500 font-bold text-[10px] uppercase tracking-widest">
            ...
            <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">{t.contact}</a>
          </div>
